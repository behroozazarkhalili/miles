...
from miles.utils.types import LEGACY_WEIGHT_VERSIONS_KEY, Sample, WeightVersionSpan, WeightVersionsPerCall, prefill_lag
...
class TestWeightVersionsPerCallPrefillLag:
    ...
    def test_a_call_without_output_spans_has_no_lag(self):
        ...
        assert prefill_lag(call) is None
    ...
    def test_a_call_without_prefill_spans_has_no_lag(self):
        ...
        assert prefill_lag(WeightVersionsPerCall(spans=[WeightVersionSpan("4", 2, 3)], output_start=2)) is None
