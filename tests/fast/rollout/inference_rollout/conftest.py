...
def make_eval_args(*, partition_radix_cache_by_rollout_call: bool = True) -> dict[str, Any]:
    return dict(
        partition_radix_cache_by_rollout_call=partition_radix_cache_by_rollout_call,
        partial_rollout=False,
        mask_offpolicy_in_partial_rollout=False,
        group_rm=False,
        sglang_router_policy="round_robin",
