...
class TestExplicitWeightVersion:
    ...
    def test_a_protocol_that_published_nothing_reports_the_previous_ordinal(self):
        """The disk-delta baseline only captures a snapshot, so the candidate must stay free for the first real delta."""
        calls: list[tuple[int, str, dict]] = []
