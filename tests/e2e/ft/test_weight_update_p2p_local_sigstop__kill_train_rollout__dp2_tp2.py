...
# tests/e2e/ft/conftest_ft/scenario_weight_update_p2p_local_sigstop.py.

from tests.ci.ci_register import register_cuda_ci
from tests.e2e.ft.conftest_ft.scenario_weight_update_p2p_local_sigstop import run_ci
